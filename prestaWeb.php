            ...
            <section class="container-fluid">
                <div class="row r-m"> 
                    <article class="col-xs-12">
                        ...
                        <!--    <ul>
                                <li>Audit de votre parc informatique et conseil</li>
                                <li>Mise en place de contrat de maintenance et de solutions de sauvegarde</li>
                                <li>Diagnostic et dépannage informatique</li>
                                <li>Vente et installation de matériel informatique</li>
                                <li>Câblage, brassage et mise en réseau</li>
                            ...
                            <h3>Hébergement de site web</h3>
                                <p>Nous vous proposons un hébergement en fonction du site que vous voulez mettre en place et en tenant compte des éventuelles évolutions.</p><br>

                            <h3>Réservation de nom de domaine</h3>
                                <p>Nous vous aidons à trouver un nom de domaine disponible et nous vous le réservons.</p><br>

                            <h3>Mise à jour de site</h3>
                                <p>Nous restons disponibles pour les mises à jour et les évolutions nécessaires.</p><br>
